...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
	    ...
	    function App() {
	        ...
	        _this._handleCommentSubmit = _this.handleCommentSubmit.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function handleCommentSubmit(author, text) {
	            var data = !this.state.online ? [] : this.state.online;
	            var that = this,
	            ...
	            _ajax2.default.set(data, function (res) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_commentBox2.default, { data: this.state, onCommentSubmit: this._handleCommentSubmit })
	            );
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var Ajax = (function () {
	    function Ajax() {
	        ...
	        this.url = "http://hdapi.37.com/?c=datatest&a=get_and_set&alias_info=datatest&f=201603&alias=1";
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = (function (_React$Component) {
	    ...
	    _createClass(CommentBox, [{
	        key: 'render',
	        value: function render() {
	            var commentListDom = !this.props.data.online ? _react2.default.createElement(
	                'p',
	                null,
	                'List is empty!'
	            ) : _react2.default.createElement(_commentList2.default, { data: this.props.data.online });
	            return _react2.default.createElement(
	                'div',
	                ...
	                commentListDom,
	                _react2.default.createElement(_commentForm2.default, { onCommentSubmit: this.props.onCommentSubmit })
	            );
	        }
	    }]);
	    ...
	    _createClass(Comment, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                ':',
	                _react2.default.createElement('span', { className: 'commentText', dangerouslySetInnerHTML: this.rawMarkup() })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = (function (_React$Component) {
	    ...
	    function CommentForm() {
	        ...
	        _this._handleAuthorChange = _this.handleAuthorChange.bind(_this);
	        _this._handleTextChange = _this.handleTextChange.bind(_this);
	        _this._handleCommentSubmit = _this.handleCommentSubmit.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(CommentForm, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'form',
	                { className: 'commentForm', onSubmit: this._handleCommentSubmit },
	                _react2.default.createElement('input', { type: 'text', value: this.state.author, placeholder: 'Your name', onChange: this._handleAuthorChange }),
	                _react2.default.createElement('input', { type: 'text', value: this.state.text, placeholder: 'Say something', onChange: this._handleTextChange }),
